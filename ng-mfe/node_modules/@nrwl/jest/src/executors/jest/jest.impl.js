...
function batchJest(taskGraph, inputs, overrides, context) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        const configs = yield Promise.all(configPaths.map((path) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () { return (0, jest_config_1.readConfig)({ $0: '', _: undefined }, path); })));
