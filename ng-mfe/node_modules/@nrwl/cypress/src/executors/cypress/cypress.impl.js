...
function cypressExecutor(options, context) {
    ...
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        let success;
        try {
            for (var _b = (0, tslib_1.__asyncValues)(startDevServer(options, context)), _c; _c = yield _b.next(), !_c.done;) {
...
function startDevServer(opts, context) {
    return (0, tslib_1.__asyncGenerator)(this, arguments, function* startDevServer_1() {
        var e_2, _a;
        // no dev server, return the provisioned base url
        if (!opts.devServerTarget || opts.skipServe) {
            yield yield (0, tslib_1.__await)(opts.baseUrl);
        ...
        try {
            for (var _b = (0, tslib_1.__asyncValues)(yield (0, tslib_1.__await)((0, devkit_1.runExecutor)({ project, target, configuration }, 
            ...
            targetSupportsWatchOpt ? { watch: opts.watch } : {}, context))), _c; _c = yield (0, tslib_1.__await)(_b.next()), !_c.done;) {
                const output = _c.value;
                if (!output.success && !opts.watch)
                    throw new Error('Could not compile application files');
                yield yield (0, tslib_1.__await)(opts.baseUrl || output.baseUrl);
            }
        }
