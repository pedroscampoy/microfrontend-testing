...
function conversionGenerator(host, options) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        const projectConverter = new linter_1.ProjectConverter({
            ...
            eslintInitializer: ({ projectName, projectConfig }) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        const { project } = options, defaults = (0, tslib_1.__rest)(options, ["project"]);
        /**
