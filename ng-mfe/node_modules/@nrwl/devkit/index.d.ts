 ...
 * @category Workspace
 */
export type { WorkspaceJsonConfiguration, TargetDependencyConfig, TargetConfiguration, ProjectConfiguration, ProjectType, Generator, GeneratorCallback, Executor, ExecutorContext, TaskGraphExecutor, Workspace, } from 'nx/src/shared/workspace';
export type { NxPlugin, ProjectTargetConfigurator, } from 'nx/src/shared/nx-plugin';
/**
 * @category Workspace
 */
 ...
 * @category Workspace
 */
export type { ImplicitDependencyEntry, ImplicitJsonSubsetDependency, NxJsonConfiguration, NxJsonProjectConfiguration, NxAffectedConfig, } from 'nx/src/shared/nx';
/**
 * @category Logger
 */
 ...
 * @category Package Manager
 */
export { getPackageManagerCommand, detectPackageManager, getPackageManagerVersion, } from 'nx/src/shared/package-manager';
/**
 * @category Commands
 */
 ...
 */
export type { ProjectFileMap, FileData, ProjectGraph, ProjectGraphV4, ProjectGraphDependency, ProjectGraphNode, ProjectGraphProjectNode, ProjectGraphExternalNode, ProjectGraphProcessorContext, } from './src/project-graph/interfaces';
/**
 * @category Project Graph
 */
