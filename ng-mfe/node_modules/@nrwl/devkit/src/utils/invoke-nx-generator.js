...
function createRunCallbackTask() {
    return {
        name: 'RunCallback',
        create: () => {
            return Promise.resolve(({ callback }) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                yield callback();
            }));
        },
    };
...
function invokeNxGenerator(generator, options) {
    return (tree, context) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
...
class DevkitTreeFromAngularDevkitTree {
    ...
    read(filePath, encoding) {
        ...
        if (isWorkspaceJsonChange(filePath)) {
            const formatted = (0, workspace_1.toNewFormat)((0, json_1.parseJson)(Buffer.isBuffer(rawResult) ? rawResult.toString() : rawResult));
        ...
        if (isWorkspaceJsonChange(filePath)) {
            ...
            for (const [project, configuration] of Object.entries(w.projects)) {
                if (typeof configuration === 'string') {
                    w.projects[project] = (0, json_1.parseJson)(this.tree.read(`${configuration}/project.json`));
                    w.projects[project].configFilePath = `${configuration}/project.json`;
                }
            }
            const formatted = (0, workspace_1.toOldFormatOrNull)(w);
