        ...
        projects.forEach((projectConfig, projectName) => {
            ...
            if (isReactProject) {
                ...
                tsConfig.storybook.files = uniqueArray([
                    ...
                    `${(0, devkit_1.offsetFromRoot)(storybookRoot)}node_modules/@nrwl/react/typings/cssmodule.d.ts`,
                    `${(0, devkit_1.offsetFromRoot)(storybookRoot)}node_modules/@nrwl/react/typings/image.d.ts`,
                ]);
...
exports.default = addReactTypings;
function uniqueArray(value) {
    return [...new Set(value)];
}
//# sourceMappingURL=update-storybook-react-typings.js.map