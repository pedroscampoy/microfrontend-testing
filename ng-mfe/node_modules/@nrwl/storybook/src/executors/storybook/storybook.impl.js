...
function storybookExecutor(options, context) {
    return (0, tslib_1.__asyncGenerator)(this, arguments, function* storybookExecutor_1() {
        let frameworkPath = (0, utils_1.getStorybookFrameworkPath)(options.uiFramework);
        const frameworkOptions = (yield (0, tslib_1.__await)(Promise.resolve().then(() => require(frameworkPath)))).default;
        ...
        yield (0, tslib_1.__await)(runInstance(option));
        yield yield (0, tslib_1.__await)({ success: true });
        // This Promise intentionally never resolves, leaving the process running
        yield (0, tslib_1.__await)(new Promise(() => { }));
    });
}
...
function runInstance(options) {
    ...
    return (0, server_1.buildDevStandalone)(Object.assign(Object.assign({}, options), { ci: true, configType: env.toUpperCase() })).catch((error) => {
        var _a;
