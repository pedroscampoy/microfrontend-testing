...
function getComponentProps(tree, componentPath, getArgsDefaultValueFn) {
    const props = getInputPropertyDeclarations(tree, componentPath).map((node) => {
        const decoratorContent = (0, typescript_1.findNodes)((0, typescript_1.findNodes)(node, typescript_2.SyntaxKind.Decorator)[0], typescript_2.SyntaxKind.StringLiteral);
