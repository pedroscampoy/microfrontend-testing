...
function updateNgPackagrBuilder() {
    ...
    return (0, schematics_1.chain)([
        (0, workspace_1.updateBuilderConfig)((_, target) => {
...
const removeDeprecatedOptions = (0, workspace_1.updateBuilderConfig)((options) => {
...
exports.default = () => {
    return (0, schematics_1.chain)([removeDeprecatedOptions, updateNgPackagrBuilder()]);
};
