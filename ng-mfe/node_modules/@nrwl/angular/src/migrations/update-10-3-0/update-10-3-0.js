...
function relativePath(path1, path2) {
    let path = (0, core_1.relative)((0, core_1.resolve)((0, core_1.normalize)('/'), (0, core_1.normalize)(path1)), (0, core_1.resolve)((0, core_1.normalize)('/'), path2));
    if (!path.startsWith('../')) {
        path = `./${path}`;
    }
    return path;
...
function createEditorTsConfig(project, baseConfig) {
    ...
    let relativeBaseConfigPath = baseConfig
        ? relativePath((0, core_1.normalize)(project.root), baseConfig)
        : null;
...
function updateBaseConfig(project, baseConfig) {
    return (0, workspace_1.updateJsonInTree)(baseConfig, (json) => {
        json.references.push({
            path: relativePath((0, core_1.dirname)(baseConfig), (0, core_1.join)((0, core_1.normalize)(project.root), 'tsconfig.editor.json')),
        });
        return json;
    });
}
            ...
            project.targets.forEach((target) => {
                ...
                if (target.builder === '@angular-devkit/build-angular:browser') {
                    const baseConfig = ((_a = target.options) === null || _a === void 0 ? void 0 : _a.tsConfig)
                        ? (0, core_1.resolve)((0, core_1.dirname)((0, core_1.normalize)(target.options.tsConfig)), (0, workspace_1.readJsonInTree)(host, target.options.tsConfig).extends)
                        : null;
                    if (baseConfig &&
                        !Array.isArray((0, workspace_1.readJsonInTree)(host, baseConfig).references)) {
                        return;
                    }
