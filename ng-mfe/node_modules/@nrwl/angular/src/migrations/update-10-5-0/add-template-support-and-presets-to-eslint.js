...
function updateESLintConfigForProject(projectRoot, prefix) {
    return (0, workspace_1.updateJsonInTree)((0, path_1.join)((0, core_1.normalize)(projectRoot), '.eslintrc.json'), () => createAngularEslintJson(projectRoot, prefix));
}
...
function updateProjectESLintConfigsAndBuilders(host) {
    ...
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        if (!((_a = (0, workspace_1.readJsonInTree)(host, '.eslintrc.json').overrides) === null || _a === void 0 ? void 0 : _a.length)) {
            return;
        }
        ...
        Object.keys(workspace.projects).forEach((projectName) => {
            ...
            Object.keys(project.architect || {}).forEach((targetName) => {
                ...
                if (!addedExtraDevDeps) {
                    rules.push((0, workspace_1.addDepsToPackageJson)({}, {
                ...
                const projectPrefx = project.prefix || (0, workspace_1.getNpmScope)(host);
...
function default_1() {
    return (0, schematics_1.chain)([updateProjectESLintConfigsAndBuilders, (0, workspace_1.formatFiles)()]);
}
