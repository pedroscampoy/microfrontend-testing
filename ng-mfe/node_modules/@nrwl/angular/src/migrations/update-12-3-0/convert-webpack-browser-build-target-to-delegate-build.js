...
function updateTargetsConfigurations(project, projectName, target, buildTargetName, configurationOptions) {
    for (const [configurationName, options] of configurationOptions) {
        const { buildTarget, tsConfig, outputPath } = options, delegateTargetOptions = (0, tslib_1.__rest)(options, ["buildTarget", "tsConfig", "outputPath"]);
...
function updateTargetsOptions(project, target, buildTargetName) {
    if (target.options) {
        const _a = target.options, { buildTarget, tsConfig, outputPath } = _a, delegateTargetOptions = (0, tslib_1.__rest)(_a, ["buildTarget", "tsConfig", "outputPath"]);
