    ...
    return (0, build_angular_1.executeBrowserBuilder)(options, context, {
        webpackConfiguration: (baseWebpackConfig) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            if (typeof customWebpackConfiguration === 'function') {
                return customWebpackConfiguration(baseWebpackConfig, options, context.target);
            }
            else {
...
function run(options, context) {
    ...
    if (!options.buildLibsFromSource) {
        const result = (0, buildable_libs_utils_1.calculateProjectDependencies)((0, project_graph_1.readCachedProjectGraph)(), context.workspaceRoot, context.target.project, context.target.target, context.target.configuration);
