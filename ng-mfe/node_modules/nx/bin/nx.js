...
const find_workspace_root_1 = require("../src/cli/find-workspace-root");
const chalk = require("chalk");
const init_local_1 = require("../src/cli/init-local");
const output_1 = require("../src/cli/output");
const package_manager_1 = require("../src/shared/package-manager");
